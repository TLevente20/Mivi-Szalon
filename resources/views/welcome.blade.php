    ...
    <div> 
        ...
        <div class="mx-28 flex mt-12"> 
            <div class="w-1/2 pt-8 mr-10">
                <img src="{{ asset('img/mivi.logo.png') }}" class=" absolute h-[344px] ml-24 opacity-10 -z-50">
                ...
                <a href="#" class=" uppercase text-lg font-medium bg-my-pink-100 hover:bg-my-pink-200 py-2 px-8 rounded-ss-[20px] rounded-ee-[20px] rounded-se-[4px] rounded-es-[4px] z-50 duration-300">Kapcsolatfelvétel ></a>
