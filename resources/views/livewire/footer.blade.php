<div>
    ...
    <div class="flex justify-center mt-8 mb-2">
        <a href="#"> <img src="{{asset('icon/facebook.png')}}" alt="facebook icon"></a>
        <a href="#" class="mx-8"> <img src="{{asset('icon/instagram.png')}}" alt="instagramm icon"></a>
        <a href="#"> <img src="{{asset('icon/tiktok.png')}}" alt="tiktok icon"></a>
    </div>

    <img src="{{asset('icon/curved-line.png')}}" class=" w-full">
</div>
